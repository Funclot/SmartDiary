...
public class TaskService : ITaskService
{
    ...
    public async Task<IEnumerable<Tasks>> GetUserTasksAsync(string userId)
    {
    ...
    public async Task<Tasks> CreateTaskAsync(Tasks task, string userId, int[]
   selectedTags)
    {
        task.UserId = userId;
    ...
    public async Task<Tasks?> UpdateTaskAsync(Tasks task, string userId, int[]
   selectedTags)
    {
